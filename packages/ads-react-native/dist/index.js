...
import { Image as Image2, Linking as Linking2, Pressable as Pressable2, Text as Text2, View as View2 } from "react-native";
...
function FullscreenAnuncio({ pedido, cliente, aoFechar }) {
  ...
  return /* @__PURE__ */ jsx(Modal, { visible: true, transparent: true, animationType: "fade", onRequestClose: () => podeFechar && fechar(), children: /* @__PURE__ */ jsxs(View, { style: estilos.fundo, children: [
    /* @__PURE__ */ jsxs(Pressable, { style: estilos.criativo, onPress: abrirDestino, children: [
      asset ? /* @__PURE__ */ jsx(Image, { source: { uri: asset.url }, style: estilos.imagem, resizeMode: "contain" }) : /* @__PURE__ */ jsx(Text, { style: estilos.titulo, children: anuncio.nome ?? "An\xFAncio" }),
      asset?.texto_cta ? /* @__PURE__ */ jsx(Text, { style: estilos.cta, children: asset.texto_cta }) : null
    ] }),
    anuncio.teste ? /* @__PURE__ */ jsx(Text, { style: estilos.badgeTeste, children: "An\xFAncio de teste" }) : null,
    podeFechar ? /* @__PURE__ */ jsx(Pressable, { style: estilos.fechar, onPress: fechar, accessibilityLabel: "Fechar an\xFAncio", children: /* @__PURE__ */ jsx(Text, { style: estilos.fecharTexto, children: "\xD7" }) }) : pedido.tipo === "rewarded" ? /* @__PURE__ */ jsx(View, { style: estilos.contagem, children: /* @__PURE__ */ jsxs(Text, { style: estilos.contagemTexto, children: [
      segundosRestantes,
      "s"
    ] }) }) : null
  ] }) });
...
var Contexto = alcanceGlobal.__hongaAdsCtx ??= createContext(null);
function HongaAdsProvider({ children, publisherId, apiKey, endpoint, storage }) {
  ...
  const [pedidoAtual, setPedidoAtual] = useState2(null);
  const valor = useMemo(
    () => ({
      cliente,
  ...
  return /* @__PURE__ */ jsxs2(Contexto.Provider, { value: valor, children: [
    children,
    /* @__PURE__ */ jsx2(FullscreenAnuncio, { pedido: pedidoAtual, cliente, aoFechar: () => setPedidoAtual(null) })
  ] });
}
...
function AdBanner({ unitId, style }) {
  ...
  const [resultado, setResultado] = useState3(null);
  const [semAnuncio, setSemAnuncio] = useState3(false);
  const impressaoEnviada = useRef2(false);
  useEffect2(() => {
    let cancelado = false;
  ...
  const abrirDestino = async () => {
    ...
    if (destino) {
      void Linking2.openURL(destino);
    }
  };
  return /* @__PURE__ */ jsx3(Pressable2, { onPress: abrirDestino, style, accessibilityLabel: anuncio.nome ?? "An\xFAncio", children: /* @__PURE__ */ jsxs3(View2, { style: { width: "100%", aspectRatio: ratio }, children: [
    /* @__PURE__ */ jsx3(Image2, { source: { uri: asset.url }, style: { width: "100%", height: "100%" }, resizeMode: "contain" }),
    anuncio.teste ? /* @__PURE__ */ jsx3(
      Text2,
      {
        style: {
          position: "absolute",
