...
import { dividirLinks, idMaiorOuIgual, referenciaDaMensagem, rotuloTipoIdentidade } from "@hongayetu/makachat-core";
...
import { createContext as createContext2, useCallback as useCallback3, useContext as useContext2, useEffect as useEffect4, useMemo as useMemo2, useRef as useRef3, useState as useState4 } from "react";
...
function ChamadasProvider({ children }) {
  ...
  const carregarConversa = useCallback3(
    async (conversaId) => {
  ...
  const anexarTodos = useCallback3(() => {
  ...
  const verificarMedia = useCallback3(async (video) => {
  ...
  const ligarSala = useCallback3(async (token, wsUrl, video) => {
    const r = new Room({
      adaptiveStream: true,
      dynacast: true,
    ...
    room.current = r;
    elementos.current.clear();
    r.on(RoomEvent.TrackSubscribed, (track, pub, participante) => {
  ...
  const subtitulo = ativa?.fase === "em_curso" && inicioEm ? /* @__PURE__ */ jsx3(Duracao, { desde: inicioEm }) : ativa?.fase === "falhada" ? "Chamada falhada" : ativa?.fase === "ocupado" ? "Ocupado" : ativa?.fase === "a_ligar" ? "A ligar\u2026" : ativa?.fase === "a_chamar" ? "A chamar\u2026" : `Chamada de ${ativa?.chamada.tipo === "video" ? "v\xEDdeo" : "\xE1udio"}`;
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs2("div", { className: `relative flex items-center justify-center bg-black/40 ${modo === "cheio" ? "flex-1" : "h-[300px]"}`, children: [
            ...
            (ativa.chamada.tipo === "audio" || ativa.fase !== "em_curso" || !videoRemotoVivo) && /* @__PURE__ */ jsxs2("div", { className: `z-[1] flex flex-col items-center gap-3 ${ativa.fase !== "em_curso" ? "animate-maka-pulsar" : ""}`, children: [
              ...
              ativa.fase === "em_curso" && remotoPausado && /* @__PURE__ */ jsx3("span", { className: "rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-white/75", children: "C\xE2mara em pausa" })
            ] }),
...
function CartaoReferencia({ referencia, minha, aoAbrir, mensagem, outros }) {
  ...
  return /* @__PURE__ */ jsxs3(
    "button",
    {
      ...
      children: [
        referencia.imagem_url ? /* @__PURE__ */ jsx4("img", { src: referencia.imagem_url, alt: "", className: "h-[72px] w-[72px] shrink-0 object-cover" }) : !ehLink ? (
          ...
          /* @__PURE__ */ jsx4(
            "span",
            {
              ...
              children: /* @__PURE__ */ jsx4(Icon3, { icon: "tabler:photo", className: "text-xl" })
            }
          )
        ) : null,
        /* @__PURE__ */ jsxs3("span", { className: "flex min-w-0 flex-col justify-center gap-0.5 px-3 py-2", children: [
          /* @__PURE__ */ jsx4("span", { className: "truncate text-sm font-bold", children: String(referencia.titulo ?? referencia.url ?? "Anexo") }),
          referencia.subtitulo && /* @__PURE__ */ jsx4("span", { className: "truncate text-xs opacity-75", children: referencia.subtitulo }),
          /* @__PURE__ */ jsxs3("span", { className: "flex items-center gap-1 text-[10px] opacity-60", children: [
            referencia.emoji ? /* @__PURE__ */ jsx4("span", { children: referencia.emoji }) : /* @__PURE__ */ jsx4(Icon3, { icon: ehLink ? "tabler:link" : "tabler:photo" }),
            String(referencia.tipo || "liga\xE7\xE3o")
          ] })
        ] })
      ]
    }
...
function MakaChatConversas({ arquivadas = false, conversaAtivaId, onAbrirConversa, tituloVazio, textoVazio, renderVazio }) {
  ...
  const [verOnline, setVerOnline] = useState5(false);
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "flex h-full flex-col bg-[var(--maka-superficie)]", children: [
    /* @__PURE__ */ jsxs3("div", { className: "flex items-center gap-1 px-4 pt-2.5 pb-0.5", children: [
      ...
      podePresenca && aoAlternarPresenca && !verArquivadas && /* @__PURE__ */ jsx4(
        BotaoIcone,
        {
          titulo: visibilidadePresenca ? "Est\xE1s vis\xEDvel \u2014 tocar para esconder o teu estado online" : "Estado online escondido \u2014 tocar para mostrar",
          onClick: () => void aoAlternarPresenca(),
          children: /* @__PURE__ */ jsx4(Icon3, { icon: visibilidadePresenca ? "tabler:eye" : "tabler:eye-off" })
        }
      ),
      obterOnline && !verArquivadas && /* @__PURE__ */ jsx4(BotaoIcone, { titulo: "Pessoas online", onClick: () => setVerOnline(true), children: /* @__PURE__ */ jsxs3("span", { className: "relative grid place-items-center", children: [
        /* @__PURE__ */ jsx4(Icon3, { icon: "tabler:users" }),
        /* @__PURE__ */ jsx4("span", { className: "absolute -right-0.5 -top-0.5 h-2 w-2 rounded-full bg-emerald-500 ring-2 ring-[var(--maka-superficie)]" })
      ] }) }),
    ...
    /* @__PURE__ */ jsxs3("div", { className: "maka-scroll min-h-0 flex-1 overflow-y-auto", onScroll: (e) => void aoScrollLista(e), children: [
      ...
      ] }) : busca.trim() ? /* @__PURE__ */ jsx4("div", { className: "pt-16 text-center text-sm text-[var(--maka-texto-suave)]", children: "Sem resultados." }) : renderVazio ? /* @__PURE__ */ jsx4(Fragment2, { children: renderVazio() }) : /* @__PURE__ */ jsxs3("div", { className: "flex flex-col items-center px-8 pt-14 text-center", children: [
        /* @__PURE__ */ jsx4("div", { className: "mb-4 grid h-20 w-20 place-items-center rounded-full", style: { backgroundColor: "color-mix(in srgb, var(--maka-primaria) 10%, transparent)" }, children: /* @__PURE__ */ jsx4(Icon3, { icon: verArquivadas ? "tabler:archive" : "tabler:messages", className: "text-4xl text-[var(--maka-primaria)]" }) }),
        /* @__PURE__ */ jsx4("span", { className: "mb-1 text-[15px] font-extrabold text-[var(--maka-texto)]", children: tituloVazio ?? (verArquivadas ? "Nada arquivado" : "Ainda sem conversas") }),
        /* @__PURE__ */ jsx4("span", { className: "text-[13px] leading-snug text-[var(--maka-texto-suave)]", children: textoVazio ?? (verArquivadas ? "As conversas que arquivares aparecem aqui." : "Quando come\xE7ares a falar com algu\xE9m, as conversas aparecem aqui.") }),
        !verArquivadas && podeCriarConversa && /* @__PURE__ */ jsxs3(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx4(Icon3, { icon: "tabler:plus" }),
              "Come\xE7ar conversa"
            ]
          }
        )
      ...
      /* @__PURE__ */ jsxs3("div", { className: "maka-scroll min-h-0 flex-1 overflow-auto border-0 border-t border-solid border-black/5", children: [
        membros.map((p) => {
          ...
          return /* @__PURE__ */ jsxs3("div", { className: "flex items-center gap-3 px-4 py-2.5", children: [
            ...
            !souEu && souAdmin && p.papel !== "dono" && /* @__PURE__ */ jsx4(
              BotaoIcone,
              {
                ...
                children: /* @__PURE__ */ jsx4(Icon3, { icon: p.papel === "admin" ? "tabler:shield-off" : "tabler:shield-plus" })
              }
            ),
...
function OnlineModal({ aoFechar, aoCriada }) {
  ...
  const [pessoas, setPessoas] = useState5(null);
  const [aCriar, setACriar] = useState5(false);
  useEffect5(() => {
  ...
  return /* @__PURE__ */ jsx4("div", { className: "fixed inset-0 z-[10000] grid place-items-center bg-slate-900/50 backdrop-blur-sm", onClick: aoFechar, children: /* @__PURE__ */ jsxs3("div", { className: "flex max-h-[74vh] w-[360px] animate-maka-subir flex-col overflow-hidden rounded-2xl bg-[var(--maka-superficie)] shadow-maka-modal", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxs3("div", { className: "flex items-center justify-between px-4 py-3", children: [
      /* @__PURE__ */ jsxs3("span", { className: "flex items-center gap-2 font-bold text-[var(--maka-texto)]", children: [
        /* @__PURE__ */ jsx4("span", { className: "h-2.5 w-2.5 rounded-full bg-emerald-500" }),
        "Online agora"
      ] }),
      /* @__PURE__ */ jsx4(BotaoIcone, { titulo: "Fechar", onClick: aoFechar, children: /* @__PURE__ */ jsx4(Icon3, { icon: "tabler:x" }) })
    ] }),
    /* @__PURE__ */ jsxs3("div", { className: "maka-scroll min-h-0 flex-1 overflow-auto pb-2", children: [
      pessoas === null && /* @__PURE__ */ jsxs3("div", { className: "flex items-center justify-center gap-2 px-4 py-8 text-sm text-[var(--maka-texto-suave)]", children: [
        /* @__PURE__ */ jsx4(Icon3, { icon: "tabler:loader-2", className: "animate-spin" }),
        " A carregar\u2026"
      ] }),
      pessoas !== null && pessoas.length === 0 && /* @__PURE__ */ jsx4("div", { className: "px-4 py-8 text-center text-sm text-[var(--maka-texto-suave)]", children: "Ningu\xE9m online agora." }),
      (pessoas ?? []).map((p) => /* @__PURE__ */ jsxs3(
        "button",
        {
          disabled: aCriar,
          ...
          children: [
            /* @__PURE__ */ jsxs3("span", { className: "relative", children: [
              /* @__PURE__ */ jsx4(AvatarWeb, { nome: p.nome ?? p.id_externo, url: p.foto, tamanho: 38 }),
              /* @__PURE__ */ jsx4("span", { className: "absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full bg-emerald-500 ring-2 ring-[var(--maka-superficie)]" })
            ] }),
            /* @__PURE__ */ jsx4("span", { className: "min-w-0 flex-1 truncate text-sm font-semibold text-[var(--maka-texto)]", children: p.nome ?? p.id_externo }),
            /* @__PURE__ */ jsx4(Icon3, { icon: "tabler:message-circle", className: "text-[var(--maka-texto-suave)]" })
          ]
        },
        `${p.tipo}:${p.id_externo}`
      ))
...
function NovaConversaModal({ conversas, contactos, podeGrupos, aoFechar, aoCriada }) {
  ...
  return /* @__PURE__ */ jsx4("div", { className: "fixed inset-0 z-[10000] grid place-items-center bg-slate-900/50 backdrop-blur-sm", onClick: aoFechar, children: /* @__PURE__ */ jsxs3("div", { className: "flex max-h-[74vh] w-[380px] animate-maka-subir flex-col overflow-hidden rounded-2xl bg-[var(--maka-superficie)] shadow-maka-modal", onClick: (e) => e.stopPropagation(), children: [
    ...
    /* @__PURE__ */ jsx4("div", { className: "px-4 pb-2", children: /* @__PURE__ */ jsxs3("div", { className: "flex items-center gap-2 rounded-full bg-[var(--maka-fundo)] px-3.5", children: [
      /* @__PURE__ */ jsx4(Icon3, { icon: "tabler:search", className: "shrink-0 text-[var(--maka-texto-suave)]" }),
      /* @__PURE__ */ jsx4(
        "input",
        {
      ...
      aPesquisar && /* @__PURE__ */ jsx4(Icon3, { icon: "tabler:loader-2", className: "shrink-0 animate-spin text-[var(--maka-texto-suave)]" })
    ] }) }),
    podeGrupos && !busca.trim() && /* @__PURE__ */ jsx4("div", { className: "px-4 pb-1 text-xs text-[var(--maka-texto-suave)]", children: "Escolhe uma pessoa \u2014 ou v\xE1rias para criar um grupo." }),
    ...
    /* @__PURE__ */ jsxs3("div", { className: "maka-scroll min-h-0 flex-1 overflow-auto", children: [
      pessoas.length === 0 && /* @__PURE__ */ jsx4("div", { className: "px-4 py-6 text-sm text-[var(--maka-texto-suave)]", children: busca.trim() ? aPesquisar ? "A pesquisar\u2026" : "Sem resultados." : "Sem contactos conhecidos \u2014 usa a pesquisa." }),
      pessoas.map((p) => {
        const chave = `${p.tipo}:${p.id_externo}`;
        const marcado = escolhidos.has(chave);
        return /* @__PURE__ */ jsxs3(
...
function ConversaPainel({ conversaId, compacto = false, aoFechar, aoMinimizar, aoAbrirOutraConversa }) {
  ...
  const [conversa, setConversa] = useState5(() => engine.conversaEmCache(conversaId));
...
function Bolha({ mensagem: m, minha, grupo, participantes, outros, acoes, todas, destacada, registarRef, aoAbrirFoto, aoClicarCitacao, aoVerReacoes, podeReagir, primeiraDoBloco = true, ultimaDoBloco = true, autor = null, compacto = false }) {
  ...
  const popovers = !m.eliminada && /* @__PURE__ */ jsxs3(Fragment2, { children: [
    ...
    menu && /* @__PURE__ */ jsxs3("div", { "data-maka-pop": `bolha-${m.id}`, className: `absolute ${menuCima ? posCima : posBaixo} z-[3] min-w-[150px] overflow-hidden rounded-xl bg-[var(--maka-superficie)] shadow-maka-pop ring-1 ring-black/[.05] ${minha ? "right-0" : "left-0"}`, children: [
      acoes.reenviar && /* @__PURE__ */ jsxs3(ItemMenu, { onClick: acoes.reenviar, children: [
        /* @__PURE__ */ jsx4(Icon3, { icon: "tabler:refresh", className: "inline align-[-2px]" }),
        " Tentar de novo"
      ] }),
        ...
        /* @__PURE__ */ jsxs3(
          "div",
          {
            ...
            children: [
              ...
              !m.eliminada && referencia && /* @__PURE__ */ jsx4(CartaoReferencia, { referencia, minha, aoAbrir: abrirReferencia, mensagem: m, outros }),
...
import React5, { createContext as createContext3, useCallback as useCallback4, useContext as useContext3, useEffect as useEffect6, useState as useState6 } from "react";
...
function MakaChatDock({ autoAbrir = true, visivel = true, maxBoxes = 3, queryParam = false, children }) {
  ...
  const fechar = useCallback4((conversaId) => {
              ...
              /* @__PURE__ */ jsxs4(
                "button",
                {
                  ...
                  children: [
                    ...
                    (conversa?.participante?.mensagens_nao_lidas ?? 0) > 0 && /* @__PURE__ */ jsx5(
                      "span",
                      {
