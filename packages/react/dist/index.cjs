...
function MakaChatProvider({ serviceKey, identity, getToken, storage, tema, contactos, pesquisarContactos, obterOnline, notificacoesNativas = false, aoAbrirNotificacao, aoAbrirPartilha, aoAbrirReferencia, aoVerPerfil, visibilidadePresenca, aoAlternarPresenca, envioBloqueado, aoBloquear, aoDenunciar, children }) {
  ...
  const abrirReferencia = (0, import_react.useCallback)(
    (ref, contexto) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Contexto.Provider, { value: { ...par.contexto, features, ligado, contactos: contactos ?? [], pesquisarContactos, obterOnline, aoAbrirPartilha, aoAbrirReferencia, abrirReferencia, aoVerPerfil, visibilidadePresenca, aoAlternarPresenca, envioBloqueado, aoBloquear, aoDenunciar }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "contents", ...cssVarsDoTema(tema) }, children }) });
}
...
function CartaoReferencia({ referencia, minha, aoAbrir, mensagem, outros }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "button",
    {
      ...
      children: [
        referencia.imagem_url ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("img", { src: referencia.imagem_url, alt: "", className: "h-[72px] w-[72px] shrink-0 object-cover" }) : !ehLink ? (
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "span",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react7.Icon, { icon: "tabler:photo", className: "text-xl" })
            }
          )
        ) : null,
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "flex min-w-0 flex-col justify-center gap-0.5 px-3 py-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "truncate text-sm font-bold", children: String(referencia.titulo ?? referencia.url ?? "Anexo") }),
          referencia.subtitulo && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "truncate text-xs opacity-75", children: referencia.subtitulo }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "flex items-center gap-1 text-[10px] opacity-60", children: [
            referencia.emoji ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: referencia.emoji }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react7.Icon, { icon: ehLink ? "tabler:link" : "tabler:photo" }),
...
function MakaChatConversas({ arquivadas = false, conversaAtivaId, onAbrirConversa, tituloVazio, textoVazio, renderVazio }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex h-full flex-col bg-[var(--maka-superficie)]", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-1 px-4 pt-2.5 pb-0.5", children: [
      ...
      podePresenca && aoAlternarPresenca && !verArquivadas && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        BotaoIcone,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react7.Icon, { icon: visibilidadePresenca ? "tabler:eye" : "tabler:eye-off" })
        }
      ),
...
function InfoConversa({ conversa, eu, aoFechar, aoAbrirOutraConversa, aoSaiu }) {
  ...
  const [confirmarBloqueio, setConfirmarBloqueio] = (0, import_react8.useState)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "fixed inset-0 z-[10000] grid place-items-center bg-slate-900/50 backdrop-blur-sm", onClick: aoFechar, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex max-h-[80vh] w-[380px] animate-maka-subir flex-col overflow-hidden rounded-2xl bg-[var(--maka-superficie)] shadow-maka-modal", onClick: (e) => e.stopPropagation(), children: [
      ...
      !grupo && contraparteInfo && (aoBloquear || aoDenunciar) && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex gap-2 border-0 border-t border-solid border-black/5 p-3", children: [
        aoDenunciar && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "button",
          {
        ...
        aoBloquear && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "button",
          {
    ...
    confirmarBloqueio && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ConfirmarDialogo,
      {
...
function RelatorioEntregaWeb({ conversaId, mensagem, aoFechar }) {
  const { api } = useMakaChat();
  const [recibos, setRecibos] = (0, import_react8.useState)(null);
  (0, import_react8.useEffect)(() => {
    let vivo = true;
  ...
  const seccao = (titulo, icone, cor, lista) => lista.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "mt-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "mb-1 flex items-center gap-1.5 text-xs font-bold uppercase text-[var(--maka-texto-suave)]", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react7.Icon, { icon: icone, style: { color: cor } }),
      " ",
      titulo,
      " \xB7 ",
      lista.length
    ] }),
    lista.map((r) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-3 py-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AvatarWeb, { nome: r.nome, url: r.foto_url, tamanho: 36 }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "min-w-0 flex-1 truncate text-sm font-semibold text-[var(--maka-texto)]", children: r.nome }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react7.Icon, { icon: icone, style: { color: cor } })
    ] }, r.identidade_id))
  ] });
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "fixed inset-0 z-[10003] grid place-items-center bg-slate-900/50", onClick: aoFechar, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex max-h-[74vh] w-[360px] animate-maka-subir flex-col overflow-hidden rounded-2xl bg-[var(--maka-superficie)] shadow-maka-modal", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center justify-between px-4 py-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "font-bold text-[var(--maka-texto)]", children: "Relat\xF3rio de entrega" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BotaoIcone, { titulo: "Fechar", onClick: aoFechar, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react7.Icon, { icon: "tabler:x" }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "maka-scroll min-h-0 flex-1 overflow-auto px-4 pb-4", children: [
      mensagem.conteudo && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "truncate text-[13px] italic text-[var(--maka-texto-suave)]", children: [
        "\u201C",
        mensagem.conteudo,
        "\u201D"
      ] }),
      recibos === null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-2 py-6 text-sm text-[var(--maka-texto-suave)]", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react7.Icon, { icon: "tabler:loader-2", className: "animate-spin" }),
        " A carregar\u2026"
      ] }) : vistos.length === 0 && entregues.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "py-6 text-center text-sm text-[var(--maka-texto-suave)]", children: "Ainda ningu\xE9m recebeu esta mensagem." }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
...
function ConversaPainel({ conversaId, compacto = false, aoFechar, aoMinimizar, aoAbrirOutraConversa }) {
  ...
  const [conversa, setConversa] = (0, import_react8.useState)(() => engine.conversaEmCache(conversaId));
  ...
  const [relatorioDe, setRelatorioDe] = (0, import_react8.useState)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "relative flex h-full min-w-0 flex-col bg-[var(--maka-fundo)] text-[var(--maka-texto)]", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: `z-[1] flex items-center gap-3 border-0 border-b border-solid border-black/[.06] bg-[var(--maka-superficie)] ${compacto ? "px-3 py-2" : "px-4 py-2.5"}`, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "min-w-0 flex-1 cursor-pointer", onClick: () => setInfoAberta(true), children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: `block text-xs ${typingOutro ? "italic text-[var(--maka-primaria)]" : presenca?.online || membrosOnline > 0 ? "text-emerald-600" : "text-[var(--maka-texto-suave)]"}`, children: typingOutro ? "a escrever\u2026" : grupoHeader ? membrosOnline > 0 ? `${membrosOnline} online` : `${outros.length + 1} membros` : presenca?.online ? "online" : "" })
      ] }),
    ...
    relatorioDe && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(RelatorioEntregaWeb, { conversaId, mensagem: relatorioDe, aoFechar: () => setRelatorioDe(null) }),
...
function BarraInput({ compacto, texto, setTexto, placeholder, aoEnviar, podeMedia, podeGravar, aEnviarMedia, aoAnexar, aoGravarAudio, desativado = false }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: `flex items-center gap-2 border-0 border-t border-solid border-black/[.06] bg-[var(--maka-superficie)] ${compacto ? "p-2" : "p-3"}`, children: [
    podeMedia && !desativado && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BotaoIcone, { titulo: "Anexar", onClick: aoAnexar, children: aEnviarMedia ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react7.Icon, { icon: "tabler:loader-2", className: "animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react7.Icon, { icon: "tabler:paperclip" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      "textarea",
      {
        rows: 1,
    ...
    texto.trim() === "" && podeGravar && !desativado ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      "button",
      {
...
function Bolha({ mensagem: m, minha, grupo, participantes, outros, acoes, todas, destacada, registarRef, aoAbrirFoto, aoClicarCitacao, aoVerReacoes, podeReagir, primeiraDoBloco = true, ultimaDoBloco = true, autor = null, compacto = false }) {
  ...
  const referencia = (0, import_makachat_core2.referenciaDaMensagem)(m);
  ...
  const popovers = !m.eliminada && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
    ...
    menu && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { "data-maka-pop": `bolha-${m.id}`, className: `absolute ${menuCima ? posCima : posBaixo} z-[3] min-w-[150px] overflow-hidden rounded-xl bg-[var(--maka-superficie)] shadow-maka-pop ring-1 ring-black/[.05] ${minha ? "right-0" : "left-0"}`, children: [
      ...
      acoes.relatorio && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(ItemMenu, { onClick: acoes.relatorio, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react7.Icon, { icon: "tabler:checks", className: "inline align-[-2px]" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              !m.eliminada && referencia && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CartaoReferencia, { referencia, minha, aoAbrir: abrirReferencia, mensagem: m, outros }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "relative z-[20] mb-4", "data-maka-pop": "dock-popover", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "button",
          {
            ...
            children: [
              icone ?? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_react9.Icon, { icon: "tabler:message-circle-filled" }),
